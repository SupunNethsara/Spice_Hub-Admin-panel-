...
export default function Stats() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://127.0.0.1:8000/api/countitems');
    ...
    return (
        <div>
            <div class="m-6">
                {stats ? (<div class="flex flex-wrap -mx-6">
                    ...
                    <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                        <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-slate-100">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700">{stats.count}</h4>
